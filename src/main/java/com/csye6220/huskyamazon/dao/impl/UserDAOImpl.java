...
@Repository // 标记这是一个 DAO component
public class UserDAOImpl implements UserDAO {

    // Inject JPA 的 EntityManager，它是 Spring Boot 管理 Hibernate 的入口
    ...
    // 辅助method：Get Hibernate 原生 Session
    ...
    public User findByUsername(String username) {
        ...
        // uniqueResult() If找不到会return null
